...
class MakeEmbed:
    ...
    def __init__(self):
        ...
        self.model_file = "./chatbot_data/pretraining/word2vec_skipgram_{}_{}_{}".format(self.vector_size, self.window_size, self.min_count)
        self.epoch_logger = EpochLogger()

    def word2vec_init(self):
        self.word2vec = Word2Vec(vector_size=self.vector_size,
