...
class MakeDataset:
    def __init__(self, pos_flag = False):
        ...
        self.intent_ood_label_dir = "./chatbot_data/dataset/intent_label_with_ood.json"
        ...
        self.ood_data_dir = "./chatbot_data/dataset/ood_data.csv"
        ...
        vocab_file = "./chatbot_data/pretraining/chatbot.model"
